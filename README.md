...
A static page generator that supports multiple languages, templating, two-level menus, content categories (_"content types"_) and direct rendering of system command outputs into content.
